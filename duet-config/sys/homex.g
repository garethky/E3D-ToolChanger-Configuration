...
; This axis can only be homed when Y is homed AND Y is at the correct position to hit the physical X switch
...
G1 H1 X-400 F200         ; repeat the homing move at a lower speed for accuracy
