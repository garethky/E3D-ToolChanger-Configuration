...
;Move in
G1 X{move.axes[state.nextTool].workplaceOffsets[1]} Y230 F10500

;Collect
G1 X{move.axes[state.nextTool].workplaceOffsets[1]} Y{move.axes[state.nextTool].workplaceOffsets[2]} F2400
...
;Move Out
G1 X{move.axes[state.nextTool].workplaceOffsets[1]} Y150 F4800
